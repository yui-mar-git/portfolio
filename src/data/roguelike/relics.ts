...
export const RELIC_DB: Record<string, Relic & { isFixed?: boolean }> = {
  ...
  'book_madousyo': { id: 'book_madousyo', name: '魔導書', desc: '属性攻撃の消費MP -1', image: new URL('../../assets/games/roguelike/images/relics/book_madousyo_necronomicon.png', import.meta.url).href },
